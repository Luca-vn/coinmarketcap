...
def schedule_jobs():
    ...
    scheduler.add_job(log_funding_data, "interval", minutes=5)
    scheduler.add_job(log_price_volume_data, "interval", minutes=5)
    scheduler.add_job(log_and_analyze_bot_action, "interval", minutes=5)
    scheduler.start()
